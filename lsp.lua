    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd("LspAttach", {
        ...
        callback = function(ev)
          ...
          vim.keymap.set("n", "gd", vim.lsp.textDocument.definition, opts)
          vim.keymap.set("n", "K", vim.lsp.textDocument.hover, opts)
          vim.keymap.set("n", "gr", vim.lsp.textDocument.references, opts)
          vim.keymap.set("n", "<leader>rn", vim.lsp.textDocument.rename, opts)
          vim.keymap.set("n", "<leader>ca", vim.lsp.textDocument.code_action, opts)
          vim.keymap.set("n", "gf", vim.lsp.textDocument.format, opts)
